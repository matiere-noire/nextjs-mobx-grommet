		...
		return (
			<html lang="fr">
				<Head>
					...
					<link rel="image_src" type="image/jpg" href={`${config.app.publicUrl}/static/facebook.jpg`} />
					...
					<meta name="twitter:summary_large_image" content={`${config.app.publicUrl}/static/facebook.jpg`} />

					<link href="//cdnjs.cloudflare.com/ajax/libs/grommet/1.6.0/grommet.min.css" rel="stylesheet" type="text/css" />
